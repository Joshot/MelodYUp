...
const FEATURES = [
  ...
  },
  {
    ...
    title: 'Key & Scale',
    desc: 'Instantly identify the musical key and scale — major, minor, and modal variants.',
  },
  {
    icon: (
...
const PROCESS = [
  { num: '01', title: 'Paste YouTube URL', desc: 'Drop any YouTube link into MelodYUp — no account required.' },
  ...
  { num: '04', title: 'Save & Practice', desc: 'Saved automatically to your library — return anytime to practice.' },
]
    ...
    <div className="min-h-screen bg-white text-[#0F172A] overflow-x-hidden">
      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2.5">
            ...
            <span className="font-bold text-lg tracking-tight">MelodYUp</span>
          </Link>
          <div className="hidden md:flex items-center gap-8">
            ...
            <Link href="/upload" className="bg-gradient-to-r from-[#4F8CFF] to-[#7C3AED] text-white px-5 py-2 rounded-xl text-sm font-semibold hover:opacity-90 transition">
              Analyze Now
            </Link>
          </div>
          <Link href="/upload" className="md:hidden bg-gradient-to-r from-[#4F8CFF] to-[#7C3AED] text-white px-4 py-2 rounded-xl text-sm font-semibold">
            Analyze
          </Link>
        </div>
      </nav>
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center text-center px-4 pt-24 overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          ...
          <svg className="absolute inset-0 w-full h-full opacity-[0.03]" xmlns="http://www.w3.org/2000/svg">
            <defs><pattern id="grid" width="40" height="40" patternUnits="userSpaceOnUse"><path d="M 40 0 L 0 0 0 40" fill="none" stroke="#0F172A" strokeWidth="1"/></pattern></defs>
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          <p className="text-[#475569] text-xl md:text-2xl max-w-2xl mx-auto mb-10 leading-relaxed font-light animate-fade-in-up delay-200">
            Paste any YouTube link. Get instant chord detection, key analysis, and BPM — saved to your library automatically.
          </p>
            ...
            <div className="flex gap-2 justify-center flex-wrap mb-4">
              {['C#m', 'F#', 'A', 'B', 'C#m', 'F#', 'A', 'B'].map((c, i) => (
                <span key={i} className={`px-4 py-2 rounded-xl font-bold text-sm border ${
                  i === 0
                    ? 'bg-gradient-to-r from-[#4F8CFF] to-[#7C3AED] text-white border-transparent'
      ...
      <section className="py-32 px-4 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div>
            <p className="text-[#4F8CFF] text-sm font-bold uppercase tracking-widest mb-4">Why MelodYUp</p>
            <h2 className="text-4xl md:text-5xl font-black mb-6 leading-tight">
              Built for musicians,<br />
              <span className="gradient-text">by engineers</span>
            </h2>
            <p className="text-[#475569] text-lg leading-relaxed mb-6">
              MelodYUp was born from a simple frustration: you hear a song, you want to play it, but finding the chords takes forever. We built a tool that does it instantly — paste a YouTube link and you’re done.
            </p>
            <p className="text-[#475569] text-lg leading-relaxed mb-8">
              No account. No paywall. No friction. Just music.
            </p>
            <div className="flex flex-col gap-3">
              {['Any YouTube video works', 'Chords saved permanently to your library', 'Follow-along highlighting synced to BPM'].map(p => (
          ...
          <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-3xl p-10 border border-[#E2E8F0]">
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                { label: 'Songs Saved', value: '12K+' },
                { label: 'Key Accuracy', value: '99%' },
      ...
      <section id="features" className="py-32 bg-[#F8FAFC] px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-[#475569] text-lg max-w-xl mx-auto">MelodYUp brings professional-grade music analysis to everyone — free, instant, no account required.</p>
          </div>
      ...
      <section id="how" className="py-32 px-4 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-[#475569] text-lg max-w-xl mx-auto">No setup, no login. Just paste and go.</p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {PROCESS.map((p, i) => (
            <div key={i} className="relative">
              {i < PROCESS.length - 1 && (
                <div className="hidden lg:block absolute top-7 left-full w-full h-px bg-gradient-to-r from-[#E2E8F0] to-transparent z-0" />
              )}
      ...
      <section className="py-32 px-4">
        <div className="max-w-4xl mx-auto bg-gradient-to-br from-[#4F8CFF] to-[#7C3AED] rounded-3xl p-16 text-center text-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            <p className="text-blue-100 text-sm font-bold uppercase tracking-widest mb-4">Free Forever — No Signup</p>
            <h2 className="text-4xl md:text-5xl font-black mb-5">Ready to learn any song?</h2>
            <p className="text-blue-100 text-lg mb-10 max-w-xl mx-auto">Paste a YouTube link and MelodYUp will extract the chords, save them, and let you practice along.</p>
            <Link href="/upload"
      ...
      <footer className="border-t border-[#E2E8F0] py-12 px-4">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold">MelodYUp</span>
          </div>
          <p className="text-[#475569] text-sm">Crafted by <span className="font-semibold text-[#0F172A]">Hyvaroo Labs</span>. Engineered for musicians.</p>
          <div className="flex gap-6">
            <Link href="/upload" className="text-[#475569] hover:text-[#0F172A] text-sm transition">Analyze</Link>
