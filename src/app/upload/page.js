...
export default function UploadPage() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      setProgress(30); setProgressLabel('Sending to Basic Pitch (Spotify)...')

      const res = await fetch('/api/analyze', { method: 'POST', body: fd })

      setProgress(80); setProgressLabel('Processing chords...')
      ...
      <div className="max-w-lg mx-auto px-5 py-12">
        ...
        {step === 1 && (
          <div className="card shadow-sm fade-up">
            ...
            <div className="mt-5 bg-blue-50 border border-blue-100 rounded-xl px-4 py-3">
              <p className="text-blue-700 text-xs font-semibold mb-0.5">✦ Powered by Basic Pitch (Spotify)</p>
              <p className="text-blue-500 text-xs">Note detection via deep learning — best results with clean recordings, minimal reverb.</p>
            </div>
        ...
        {step === 2 && (
          <div className="card text-center py-14 shadow-sm fade-up">
            ...
            <p className="text-slate-300 text-xs mb-8">This may take 30–90 seconds for longer songs</p>
